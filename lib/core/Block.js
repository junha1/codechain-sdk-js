...
var Block = /** @class */ (function () {
    function Block(data) {
        var parentHash = data.parentHash, timestamp = data.timestamp, number = data.number, author = data.author, extraData = data.extraData, transactionsRoot = data.transactionsRoot, stateRoot = data.stateRoot, nextValidatorSetHash = data.nextValidatorSetHash, score = data.score, seal = data.seal, hash = data.hash, transactions = data.transactions;
    ...
    Block.fromJSON = function (data) {
        ...
        return new this({
            ...
            nextValidatorSetHash: new codechain_primitives_1.H256(nextValidatorSetHash),
    ...
    Block.prototype.toJSON = function () {
        var _a = this, parentHash = _a.parentHash, timestamp = _a.timestamp, number = _a.number, author = _a.author, extraData = _a.extraData, transactionsRoot = _a.transactionsRoot, stateRoot = _a.stateRoot, nextValidatorSetHash = _a.nextValidatorSetHash, score = _a.score, seal = _a.seal, hash = _a.hash, transactions = _a.transactions;
        return {
    ...
    Block.prototype.getSize = function () {
        var _a = this, parentHash = _a.parentHash, timestamp = _a.timestamp, number = _a.number, author = _a.author, extraData = _a.extraData, transactionsRoot = _a.transactionsRoot, stateRoot = _a.stateRoot, nextValidatorSetHash = _a.nextValidatorSetHash, score = _a.score, seal = _a.seal, transactions = _a.transactions;
        var blockHeader = [];
